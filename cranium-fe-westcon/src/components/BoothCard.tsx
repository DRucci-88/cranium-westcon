...
const BoothCard: React.FC<Props> = ({ imgSrc, companyName, companyDesc, companyImgSrc, size = "small", className }) => {
  ...
  */
  ...
  const boothLgClass: BoothStyling = {
    ...
    layoutImgAndName: "flex lg:block flex-col sm:flex-row justify-center items-center gap-3 sm:gap-8 mb-8 lg:mb-0 lg:min-w-fit",
    ...
    desc: "text-xs sm:text-sm lg:text-base text-center lg:text-left lg:pb-12 mt-3 sm:mt-0 lg:mt-2",
  ...
  const boothMdClass: BoothStyling = {
    ...
    layoutImgAndName: "flex flex-col lg:flex-row justify-center items-center gap-3 lg:gap-8 lg:mb-8",
    layoutNameAndDesc: "min-w-fit",
    nameWithImage: "",
    nameWithDesc: "hidden",
    name: "text-2xl lg:text-3xl",
    desc: "text-xs lg:text-sm text-center mt-3 lg:mt-0",
  ...
  const boothSmClass: BoothStyling = {
    ...
    mainLayout: "flex flex-col p-8",
    layoutImgAndName: "flex flex-col justify-center items-center gap-3",
    layoutNameAndDesc: "min-w-fit",
    nameWithImage: "",
    nameWithDesc: "hidden",
    name: "text-2xl",
    desc: "text-xs text-center mt-3",
    img: "w-24 h-24"
  }
  ...
  return (
    <>
      <div className={`relative h-60 border border-neutral-400 rounded-lg black-shadow overflow-hidden ${boothClass.frame} ${className ?? ''}`}
        ...
        <div className={`${showBoothDetails ? '' : 'opacity-0'} absolute w-full h-full bg-black/50 overflow-auto transition-opacity duration-300 ${boothClass.mainLayout}`}
          ...
          <div className={boothClass.layoutImgAndName}>
            ...
            <h5 className={`font-sans font-bold text-neutral-50 ${boothClass.name} ${boothClass.nameWithImage}`}>{companyName}</h5>
          </div>
          <div className={boothClass.layoutNameAndDesc}>
            <h5 className={`font-sans font-bold text-neutral-50 ${boothClass.name} ${boothClass.nameWithDesc}`}>{companyName}</h5>
